namespace PatternsIntro.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PatternsIntro.Models.DataContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "PatternsIntro.Models.DataContext";
        }

        protected override void Seed(PatternsIntro.Models.DataContext context)
        {
